...
import { setup, tokenInitialBalance } from './MultiRewardsSharedSetup';
  ...
  describe('with a distribution', () => {
    ...
    describe('with a pool to claim into', () => {
      ...
      sharedBeforeEach(async () => {
        ...
        await vault.connect(claimer1).joinPool(destinationPoolId, claimer1.address, claimer1.address, {
          assets,
